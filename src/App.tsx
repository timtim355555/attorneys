...
const AllCitiesView = ({ setCurrentView }) => {
  const allCities = [
    ...
    'Arlington, TX', 'New Orleans, LA', 'Wichita, KS', 'Cleveland, OH', 'Tampa, FL', 'Bakersfield, CA',
    'Aurora, CO', 'Anaheim, CA', 'Honolulu, HI', 'Santa Ana, CA', 'Corpus Christi, TX', 'Riverside, CA',
    'Lexington, KY', 'Stockton, CA', 'Henderson, NV', 'Saint Paul, MN', 'St. Louis, MO', 'Cincinnati, OH',
    'Pittsburgh, PA', 'Greensboro, NC', 'Anchorage, AK', 'Plano, TX', 'Lincoln, NE', 'Orlando, FL',
    'Irvine, CA', 'Newark, NJ', 'Durham, NC', 'Chula Vista, CA', 'Toledo, OH', 'Fort Wayne, IN',
    'St. Petersburg, FL', 'Laredo, TX', 'Jersey City, NJ', 'Chandler, AZ', 'Madison, WI', 'Lubbock, TX',
    'Scottsdale, AZ', 'Reno, NV', 'Buffalo, NY', 'Gilbert, AZ', 'Glendale, AZ', 'North Las Vegas, NV',
    'Winston-Salem, NC', 'Chesapeake, VA', 'Norfolk, VA', 'Fremont, CA', 'Garland, TX', 'Irving, TX',
    'Hialeah, FL', 'Richmond, VA', 'Boise, ID', 'Spokane, WA', 'Baton Rouge, LA', 'Tacoma, WA',
    'San Bernardino, CA', 'Modesto, CA', 'Fontana, CA', 'Des Moines, IA', 'Moreno Valley, CA', 'Santa Clarita, CA',
    'Fayetteville, NC', 'Birmingham, AL', 'Oxnard, CA', 'Rochester, NY', 'Port St. Lucie, FL', 'Grand Rapids, MI',
    'Huntsville, AL', 'Salt Lake City, UT', 'Frisco, TX', 'Yonkers, NY', 'Amarillo, TX', 'Glendale, CA',
    'Huntington Beach, CA', 'McKinney, TX', 'Montgomery, AL', 'Augusta, GA', 'Aurora, IL', 'Akron, OH',
    'Little Rock, AR', 'Tempe, AZ', 'Columbus, GA', 'Overland Park, KS', 'Grand Prairie, TX', 'Tallahassee, FL',
    'Cape Coral, FL', 'Mobile, AL', 'Knoxville, TN', 'Shreveport, LA', 'Worcester, MA', 'Ontario, CA',
    'Vancouver, WA', 'Sioux Falls, SD', 'Chattanooga, TN', 'Brownsville, TX', 'Fort Lauderdale, FL', 'Providence, RI',
    'Newport News, VA', 'Rancho Cucamonga, CA', 'Santa Rosa, CA', 'Peoria, AZ', 'Oceanside, CA', 'Elk Grove, CA',
    ...
    'Pasadena, TX', 'Naperville, IL', 'Bellevue, WA', 'Joliet, IL', 'Murfreesboro, TN', 'Midland, TX',
    ...
    'Orange, CA', 'Fullerton, CA', 'Charleston, SC', 'West Valley City, UT', 'Visalia, CA', 'Hampton, VA',
    'Gainesville, FL', 'Warren, MI', 'Coral Springs, FL', 'Cedar Rapids, IA', 'Round Rock, TX', 'Sterling Heights, MI',
    'Kent, WA', 'Columbia, SC', 'Santa Clara, CA', 'New Haven, CT', 'Stamford, CT', 'Concord, CA',
    'Elizabeth, NJ', 'Thousand Oaks, CA', 'Lafayette, LA', 'Simi Valley, CA', 'Topeka, KS', 'Norman, OK',
    ...
    'Allentown, PA', 'Westminster, CO', 'North Charleston, SC', 'Waterbury, CT', 'Downey, CA', 'Pompano Beach, FL',
    'Miami Gardens, FL', 'Temecula, CA', 'Everett, WA', 'Costa Mesa, CA', 'Ventura, CA', 'Inglewood, CA',
    'Antioch, CA', 'High Point, NC', 'Centennial, CO', 'Elgin, IL', 'Rochester, NY', 'Broken Arrow, OK',
    'Miami Beach, FL', 'Westminster, CA', 'Pueblo, CO', 'Lowell, MA', 'Brockton, MA', 'Rialto, CA',
    'Richmond, CA', 'Burbank, CA', 'Renton, WA', 'Davie, FL', 'Hillsboro, OR', 'Lewisville, TX',
    'Billings, MT', 'Peoria, IL', 'Tyler, TX', 'Lakeland, FL', 'Kenosha, WI', 'Chico, CA',
    'Beaverton, OR', 'Daly City, CA', 'Allen, TX', 'Green Bay, WI', 'League City, TX', 'San Mateo, CA',
    'Lakewood, WA', 'Odessa, TX', 'Bend, OR', 'Avondale, AZ', 'Cicero, IL', 'Las Cruces, NM',
    'Tuscaloosa, AL', 'Sandy Springs, GA', 'Longmont, CO', 'Boca Raton, FL', 'San Angelo, TX', 'Norwalk, CA',
    'Lawton, OK', 'Bloomington, MN', 'Danbury, CT', 'Evanston, IL', 'Redwood City, CA', 'Edinburg, TX',
    'Cranston, RI', 'Parma, OH', 'Habra, CA', 'New Bedford, MA', 'Duluth, MN', 'Plantation, FL',
    'Utica, NY', 'Burnsville, MN', 'Vacaville, CA', 'Champaign, IL', 'Spokane Valley, WA', 'Ogden, UT',
    'St. Charles, MO', 'Whittier, CA', 'Livonia, MI', 'Kirkland, WA', 'Appleton, WI', 'Danville, VA',
    'Gresham, OR', 'Southfield, MI', 'Warwick, RI', 'Citrus Heights, CA', 'Farmington Hills, MI', 'Roswell, GA'
  ];
