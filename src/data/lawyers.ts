...
export const lawyers: Lawyer[] = [
  ...
  },
  {
    ...
    about: "Experienced criminal defense attorney with a proven track record of defending clients in complex criminal cases. Former prosecutor with deep understanding of the criminal justice system. Specializes in DUI/DWI defense and federal criminal matters. Has achieved numerous acquittals and favorable plea agreements for clients facing serious charges.",
    rating: 4.8,
    reviews: 89,
  ...
  },
  {
    ...
    location: "Detroit, MI",
    phone: "(313) 555-0121",
    email: "william.johnson@detroitworkerscomp.com",
    college: "Wayne State University Law School, JD",
    about: "Workers' compensation attorney dedicated to helping injured workers get the benefits they deserve. Specializes in workplace injury claims, disability benefits, and occupational disease cases. Has successfully represented thousands of injured workers against insurance companies and employers. Known for his tenacious advocacy and compassionate client care.",
    rating: 4.6,
    reviews: 142,
    availability: 'Available'
  },
  {
    ...
    phone: "(216) 555-0122",
    email: "patricia.wilson@clevelanddisability.com",
    college: "Case Western Reserve University School of Law, JD",
    about: "Social Security Disability attorney helping disabled individuals navigate the complex disability benefits system. Specializes in SSDI and SSI claims, appeals, and hearings. Has helped thousands of disabled clients obtain the benefits they need to survive. Known for her patience, understanding, and thorough preparation of disability cases.",
    rating: 4.5,
    reviews: 189,
    availability: 'Limited'
  },
  {
    ...
    location: "Norfolk, VA",
    phone: "(757) 555-0123",
    email: "robert.davis@norfolkmilitary.com",
    college: "University of Virginia School of Law, JD",
    about: "Military law attorney and former JAG officer specializing in court-martial defense, military administrative actions, and veterans' benefits. Represents active duty service members, veterans, and their families. Expert in military justice, discharge upgrades, and VA disability claims. Understands the unique challenges facing military personnel and their families.",
    rating: 4.7,
    reviews: 78,
    availability: 'Available'
  },
  {
    ...
    phone: "(505) 555-0124",
    email: "mary.garcia@albuquerqueconsumer.com",
    college: "University of New Mexico School of Law, JD",
    about: "Consumer protection attorney fighting for consumers' rights against unfair business practices. Specializes in debt collection defense, credit reporting disputes, and consumer fraud cases. Has helped thousands of consumers resolve debt issues and protect their rights. Known for her aggressive advocacy against debt collectors and creditors.",
    rating: 4.4,
    reviews: 156,
    availability: 'Busy'
  },
  {
    ...
    phone: "(205) 555-0125",
    email: "charles.brown@birminghamcivilrights.com",
    college: "University of Alabama School of Law, JD",
    about: "Civil rights attorney dedicated to protecting constitutional rights and fighting discrimination. Specializes in police misconduct, employment discrimination, and First Amendment cases. Has successfully litigated numerous civil rights cases in federal court. Known for his passionate advocacy for justice and equality under the law.",
    rating: 4.8,
    reviews: 94,
    availability: 'Available'
  },
  {
    ...
    phone: "(801) 555-0126",
    email: "linda.martinez@saltlakenonprofit.com",
    college: "University of Utah S.J. Quinney College of Law, JD",
    about: "Nonprofit law attorney helping charitable organizations navigate complex legal requirements. Specializes in 501(c)(3) applications, tax-exempt status, and nonprofit governance. Has helped hundreds of nonprofits achieve tax-exempt status and maintain compliance. Known for her expertise in charitable giving, fundraising regulations, and board governance.",
    rating: 4.6,
    reviews: 67,
    availability: 'Limited'
  },
  {
    ...
    location: "Houston, TX",
    phone: "(713) 555-0127",
    email: "steven.anderson@houstonenergy.com",
    college: "University of Houston Law Center, JD",
    about: "Energy law attorney with extensive experience in oil and gas transactions, renewable energy projects, and regulatory compliance. Represents energy companies, landowners, and investors in complex energy deals. Expert in mineral rights, drilling contracts, and environmental regulations affecting the energy industry. Has facilitated billions in energy transactions.",
    rating: 4.7,
    reviews: 112,
    availability: 'Available'
  },
  {
    ...
    phone: "(408) 555-0128",
    email: "karen.wilson@sanjoseprivacy.com",
    college: "Santa Clara University School of Law, JD",
    about: "Privacy law attorney specializing in data protection, cybersecurity, and privacy compliance. Helps businesses navigate GDPR, CCPA, and other privacy regulations. Expert in data breach response, privacy policies, and cross-border data transfers. Works with tech companies, healthcare organizations, and financial institutions to protect sensitive data.",
    rating: 4.8,
    reviews: 85,
    availability: 'Busy'
  },
  {
    ...
    phone: "(504) 555-0129",
    email: "paul.thompson@neworleansmaritime.com",
    college: "Tulane University Law School, JD",
    about: "Maritime law attorney with decades of experience in admiralty and maritime matters. Specializes in vessel accidents, cargo disputes, and offshore injury claims. Represents shipowners, maritime workers, and cargo interests. Expert in Jones Act claims, maritime liens, and international shipping disputes. Has handled complex maritime cases worldwide.",
    rating: 4.6,
    reviews: 73,
    availability: 'Available'
  },
  {
    ...
    location: "Austin, TX",
    phone: "(512) 555-0130",
    email: "susan.clark@austincyber.com",
    college: "University of Texas School of Law, JD",
    about: "Cybersecurity law attorney helping organizations protect against cyber threats and maintain compliance. Specializes in incident response, data breach notifications, and cybersecurity frameworks. Works with technology companies, government contractors, and healthcare organizations. Expert in NIST, SOC 2, and industry-specific cybersecurity requirements.",
    rating: 4.9,
    reviews: 56,
    availability: 'Limited'
  }
